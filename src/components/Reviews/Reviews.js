  ...
  return (
    <section className="pt-[160px] md:pt-[380px] pb-[260px] md:pb-[400px] -mt-[160px] md:-mt-[315px] bg-[#f7f7f7] relative">
      <div className="max-w-[1200px] mx-auto px-[20px] md:px-[40px] relative">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-[16px] md:gap-0 mb-[40px] md:mb-[60px]">
          <div>
        ...
        <div className="flex justify-center gap-[12px] mt-[20px]">
          <span className="w-[8px] h-[8px] bg-white rounded-full cursor-pointer" />
          <span className="w-[8px] h-[8px] bg-[#555555] rounded-full cursor-pointer" />
          <span className="w-[8px] h-[8px] bg-[#555555] rounded-full cursor-pointer" />
          <span className="w-[8px] h-[8px] bg-[#555555] rounded-full cursor-pointer" />
          <span className="w-[8px] h-[8px] bg-[#555555] rounded-full cursor-pointer" />
        </div>
